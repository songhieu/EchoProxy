...
import (
	...
	httpadapter "echoproxy/proxy-gateway/internal/adapter/http"
	"echoproxy/proxy-gateway/internal/adapter/cache"
	"echoproxy/proxy-gateway/internal/adapter/kafka"
	"echoproxy/proxy-gateway/internal/adapter/postgres"
	"echoproxy/proxy-gateway/internal/infra/config"
	"echoproxy/proxy-gateway/internal/infra/logger"
	"echoproxy/proxy-gateway/internal/infra/metrics"
	"echoproxy/proxy-gateway/internal/infra/server"
